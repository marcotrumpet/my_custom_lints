...
Stream<Lint> blocxShouldMatchFileName({
  ...
  bool fileNameEndsWithValueName() =>
      fileName.replaceAll('.dart', '').split('_').last == 'blocx';

  String valueNameCapitalized() => 'blocx'.capitalize();
  ...
  if (fileNameEndsWithValueName() &&
    ...
    yield Lint(
      ...
      message:
          'If the file name ends with _blocx the className must end with ${valueNameCapitalized()}',
